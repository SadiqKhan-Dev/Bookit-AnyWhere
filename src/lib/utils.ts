...
export const LISTING_TYPE_CONFIG = {
  ...
  CRUISE: {
    ...
    icon: "ship",
    plural: "Cruises",
    description: "Luxury ship vacations",
    href: "/cruises",
  },
  MARRIAGE_HALL: {
    label: "Marriage Hall",
    ...
    plural: "Marriage Halls",
    description: "Wedding venues & banquet halls",
    href: "/marriage-halls",
  },
  CATERING: {
    label: "Catering",
